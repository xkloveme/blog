...
> \*_Note_:[hexo-abbrlink](https://github.com/rozbo/hexo-abbrlink) can genarate non-Chinese link in addtion to this plugin.
...
.bg-color {
  background-image: linear-gradient(to right, #4cbf30 0%, #027aff 100%);
}
